...
basic.vi_mode = {
	hl_colors = {
		...
		Insert = { "black", "blue", "bold" },
		Visual = { "black", "magenta", "bold" },
		Replace = { "black", "magenta", "bold" },
		Command = { "black", "magenta", "bold" },
		NormalBefore = { "blue", "black" },
		InsertBefore = { "blue", "black" },
		VisualBefore = { "magenta", "black" },
		ReplaceBefore = { "magenta", "black" },
...
local default = {
	...
	active = {
		...
		basic.git,
		basic.divider,
		{ git_comps.git_branch({ icon = " ⑆ " }), { "magenta", "black" }, 90 },
		{ " ", hl_list.Black },
		basic.vi_mode,
		basic.right,
		{ " ", hl_list.Black },
...
local explorer = {
	...
	active = {
		...
		{ vim.fn.getcwd() .. " ", { "white", "black_light" } },
	},
	always_active = true,
	show_last_status = true,
}
